...
quality_fault=[];
ruture_scarp=[];
for b=1:length(transect_results)
fault_6points=[fault_6points;transect_results(b).x_rot];
quality_fault=[quality_fault;transect_results(b).quality];

ruture_scarp=[ruture_scarp;transect_results(b).ruture_scarp];
