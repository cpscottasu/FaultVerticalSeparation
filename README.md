...
2) In "dem_folder=' \' ", use the program 7z (https://www.7-zip.org/) to unzip the files and place the unzipped files in the DEM folder. Then paste the path of the the folder "DEM"
